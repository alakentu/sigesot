$(document).ready(function () {
  ...
  function fetchTicketCount() {
    $.get('tickets/count', function (data) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener('notificationRead', (e) => {
    const badges = document.querySelectorAll(`a[href*="/admin/tickets/details/${e.detail.ticketId}"] .badge-unread-status`);
  ...
  // Disparar evento si estamos en la vista de detalle
  if (window.location.pathname.includes('/admin/tickets/details/')) {
