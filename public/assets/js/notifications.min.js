  ...
  init() {
    ...
    document.addEventListener('click', async (e) => {
      ...
      if (notificationItem) {
        ...
        const href = notificationItem.getAttribute('href'); // Guarda la URL

        if (notificationId) {
          await this.markAsRead([notificationId]); // Espera a que se complete
        }

        window.location.href = href; // Redirige manualmente
      }
    });
  }
