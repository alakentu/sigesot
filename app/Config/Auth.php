...
class Auth extends BaseConfig
{
	 ...
	 */
	public $recheckTimer             = 1800;

	public $allowRegistration		 = true;                // Allow registration of users
	 ...
	 * @var string
	 */
	public $emailTemplates = '\\App\\Views\\layouts\\email\\';
	 ...
	 * @var string
	 */
	public $emailActivate = 'activate.php';
	 ...
	 * @var string
	 */
	public $emailForgotPassword = 'forgot_password.php';
	...
	public $templates = [
		...
		'messages' => [
			'list'   => '\App\Views\layouts\messages\list',
			'single' => '\App\Views\layouts\messages\single',
		],
	];
}
